...
class TopRepositoryResponse extends BaseResponse {
  int? totalCount;
  bool? incompleteResults;
  List<ItemRepository>? items;

  TopRepositoryResponse({this.totalCount, this.incompleteResults, this.items});

  TopRepositoryResponse.fromJson(Map<String, dynamic> json) {
    totalCount = json['total_count'];
    incompleteResults = json['incomplete_results'];
    if (json['items'] != null) {
      items = <ItemRepository>[];
      json['items'].forEach((v) {
        items!.add(ItemRepository.fromJson(v));
      });
    }
  }
  ...
  TopRepositoryResponse.responseWithError(
...
class ItemRepository {
  ...
  ItemRepository.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nodeId = json['node_id'];
    name = json['name'];
