...
import 'package:github_trending/app/module/core/network/error_handlers.dart';
import 'package:github_trending/app/module/core/repository/header_provider_mixin.dart';
...
class ApiBaseHelper with HeaderProvider {
  ...
  Future<dynamic> put(String url, dynamic requestBody,
      {Map<String, dynamic>? queryParameters, bool isDecode = true}) async {
  ...
  Future<dynamic> patch(String url, dynamic requestBody) async {
    var body = json.encode(requestBody);
    dynamic responseJson;
    final _option = await getHeaders();
    try {
  ...
  Future<dynamic> delete(String url, {dynamic requestBody}) async {
    dynamic responseJson;
    final _option = await getHeaders();
    try {
